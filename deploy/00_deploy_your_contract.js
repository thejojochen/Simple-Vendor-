...
module.exports = async ({ getNamedAccounts, deployments, getChainId }) => {
  ...
  //  console.log("Transferring to frontend address");
  //  console.log(
  //    "current token balance: " + (await yourToken.balanceOf(yourToken.address))
  //  );
  //  const result = await yourToken.transfer(yourToken.address, 1);
